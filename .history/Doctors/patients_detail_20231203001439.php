    ...
    <div class="card p-3 ">
        ...
        <?php
          if (mysqli_num_rows($result) > 0) {
            ...
            <div class="col-md-6">
                <div class="inputs"> <label>ID</label> <input type="text" name="update_id"  value="<?php echo $row['id']; ?>" > </div>
            <div class="col-sm-6">
        ...
        <div class="mt-3 gap-2 d-flex justify-content-end"> 
            ...
            <button class="input"><input type="submit" value="Save" name="update_update_btn">Save</button> </div>
    </div>
            </form>
            <?php 
    }
