...
<html data-bs-theme="light" lang="en">
    ...
    <body style="background: rgb(151,187,241);border-color: rgb(146,192,238);">
        <div class="container"><!-- Start: Banner Heading Image -->
            <section class="py-4 py-xl-5"><!-- Start: 1 Row 2 Columns -->
                    <div class="container">
        ...
        <script src="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js"></script><script src="/assets/js/script.min.js?h=13b77c4c24e2b1bed1889bb37d61cd95"></script>
 </body>
</html>
    <?php
include "footer.php";
