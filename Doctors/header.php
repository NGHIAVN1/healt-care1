<!DOCTYPE html><html data-bs-theme="light" lang="en">
  ...
  <body><!-- Start: Navbar With Button -->
    <nav class="navbar navbar-expand-md bg-primary-subtle py-3" style="background: var(--bs-primary);color: rgb(20,123,225);">
      <div class="container"><a class="navbar-brand d-flex align-items-center" href="#">
        ...
        <button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button><div class="collapse navbar-collapse" id="navcol-1"><ul class="navbar-nav me-auto"><li class="nav-item"><a class="nav-link active" href="#"></a></li><li class="nav-item"><a class="nav-link" href="#">Trang chủ</a></li><li class="nav-item"><a class="nav-link" href="#">Dịch vụ</a></li><li class="nav-item dropdown show"><a class="dropdown-toggle nav-link" aria-expanded="true" data-bs-toggle="dropdown" href="#">Dropdown </a><div class="dropdown-menu show" data-bs-popper="none"><a class="dropdown-item" href="#">First Item</a><a class="dropdown-item" href="#">Second Item</a><a class="dropdown-item" href="#">Third Item</a><h6 class="dropdown-header">Header</h6><h6 class="dropdown-header">Header</h6><h6 class="dropdown-header">Header</h6><a class="dropdown-item" href="#">Menu Item</a>
</div></li></ul>
<button class="btn btn-danger link-warning border rounded-pill border-1 ms-auto" type="button" onclick="document.location=&#39;login.php&#39;" style="background: var(--bs-link-hover-color);">Đăng nhập</button>
<button class="btn btn-danger link-warning border rounded-pill" type="button">Đăng ký</button></div></div></nav><!-- End: Navbar With Button --><script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.tablesorter/2.31.2/js/jquery.tablesorter.js"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.tablesorter/2.31.2/js/widgets/widget-filter.min.js"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.tablesorter/2.31.2/js/widgets/widget-storage.min.js"></script><script src="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js"></script><script src="/assets/js/script.min.js?h=13b77c4c24e2b1bed1889bb37d61cd95"></script>
</body></html>